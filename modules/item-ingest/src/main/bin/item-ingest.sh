...
fn_run_custom_camus "${MODULE_HOME}/etc/camus/item-ingest.properties"

hadoop fs -mkdir -p "${DB_RAW_DIR}/item/batch_id=${BATCH_ID}/"

fn_hadoop_move_file "${META_DIR}/topics/item/hourly/*/*/*/*/*" "${DB_RAW_DIR}/item/batch_id=${BATCH_ID}/"

fn_delete_hdfs_directory "${META_DIR}/topics/item"

fn_run_hive \
	"${MODULE_HOME}" \
    "${MODULE_HOME}/etc/hive/item-ingest.hive.properties" \
    "${MODULE_HOME}/etc/schema/item-ingest.hql"
